        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 space-y-4">
            ...
            <p className="text-gray-700 font-semibold">
              Vendor Salary: <span className="text-gray-800 font-bold">$ { isEdit?<input type="number" onChange={(e)=>setProfileData(prev=>({...prev,fees:e.target.value}))}  value={profileData.fees}/>:profileData.fees}</span>
            </p>
